...
constexpr double k_G = 6.67E-10;

/* Number of bodies to be run in the simulation */
constexpr int k_Body_Count = 10;
...
const double k_Solar_Radius = pow(((3 * 30.0f)/(4 * M_PI)), 1.0f/3.0f);
const double K_Planet_Radius =  pow(((3 * 7.5f)/(4 * M_PI)), 1.0f/3.0f);
